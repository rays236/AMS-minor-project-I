...
if(isset($_SESSION['id'])){
  ...
  if($role == 'teacher'){
    $qt = "SELECT * FROM archived_classes WHERE teacher = '$id'";
    $rt = $pdo -> query($qt);
    while($rows = $rt ->fetch()){
...
<a href='/minorproject/new_dashboard/pages/class_for_archive.php?i=$classcode'>
<i class='bx bxs-arrow-to-right'></i>
    ...
    $sq = "SELECT * FROM archived_classes";
    $sr = $pdo->query($sq);
